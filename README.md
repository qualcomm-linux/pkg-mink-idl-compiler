# pkg-mink-idl-compiler

This is the debian packaging side of the mink-idl-compiler project.
Upstream project is hosted here : https://github.com/quic/mink-idl-compiler
...
pkg-mink-idl-compiler is licensed under the [BSD-3-clause License](https://spdx.org/licenses/BSD-3-Clause.html). See [LICENSE.txt](LICENSE.txt) for the full license text.
